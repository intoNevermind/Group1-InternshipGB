...
public class TableSitesController {
     ...
     */
    @RequestMapping(value = {"/user/ui/getIDFromSitesTable"})
     ...
     */
    @RequestMapping(value = {"/user/ui/getNameFromSitesTable"})
     ...
     */
    @RequestMapping(value = {"/user/ui/getURLFromSitesTable"})
     ...
     */
    @RequestMapping(value = {"/user/ui/getActiveFromSitesTable"})
